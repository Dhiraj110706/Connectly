...
#     likes_count = serializers.ReadOnlyField()
#     is_liked = serializers.SerializerMethodField()
#     is_image_url = serializers.ReadOnlyField()
#     is_emoji = serializers.ReadOnlyField()

#     class Meta:
#         model = Post
#         fields = ('id', 'user', 'content', 'image', 'is_image_url', 'is_emoji', 
...
#                 if not value.lower().endswith(('.jpg', '.jpeg', '.png', '.gif', '.webp', '.svg')):
#                     raise serializers.ValidationError("Please provide a valid image URL ending with .jpg, .png, .gif, .webp, or .svg")
#             # If it's longer than 10 characters and not a URL, it might be invalid
#             elif len(value) > 10:
#                 raise serializers.ValidationError("Non-URL content should be 10 characters or less (emojis/text)")
